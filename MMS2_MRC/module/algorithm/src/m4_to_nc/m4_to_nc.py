...
def m4_to_ncGenNCfile(sourcePath,destinationPath,variablename=None):
            ...
            if sourcePath:
                ...
                if sourceDict.items():
                    ...
                    if len(set(setList)) == 1:
                        ...
                        lvtemperature = nc_fid2.createVariable('variable000' if variablename == '' else variablename,"f8",("time", "level", "latitude", "longitude",),fill_value=np.NAN, zlib=True,
                                                                     least_significant_digit=3)  # 四维变量
                        ...
                        #vtime[:] = nc.date2num(sorted(list(set(times_data)),key=times_data.index), units=vtime.units, calendar=vtime.calendar)
...
if __name__ =='__main__':
    ...
    sourcePath = [r'D:\cFile\Micaps4\m4\pottmp\5.0\13010100.000']
    destinationPath = r'./456/222.nc'

    m4_to_ncGenNCfile(sourcePath, destinationPath,'')
