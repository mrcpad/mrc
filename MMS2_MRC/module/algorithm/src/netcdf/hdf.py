...
from module.algorithm.src.netcdf.netcdf import Nc, num2date
...
class HDF(Nc):
    ...
    def groups(self, value):
        self._groups = value if isinstance(value, dict) else None
    ...
    def get_variable_by_group_variable(self, group_name, var_name):
        ...
        variables = self.variables if group_name==None else self.variables[group_name]
    ...
    def get_hdf_variables_data(self):
        '''
        return hdf all variables data array,return by dict
        dict key:group  name,value:variable data
        :return:
        '''
    ...
    def __get_hdf_variable_data_by_name(self, groupname):
        '''
        get variable data array by name,return dict
        :param name:
        :return:
        '''
