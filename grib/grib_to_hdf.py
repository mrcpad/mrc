                        ...
                        if len(v) == 1:
                            if k not in list(grp.variables.keys()):
                                if len(v[0]) == 1:
                                    ...
                                    if 'level' not in list(grp.dimensions.keys()):
                                    ...
                                    if 'time' not in list(grp.variables.keys()):
                                        vtime = grp.createVariable("time", 'f8', ("time",), fill_value=0)
                                    ...
                                    if 'level' not in list(grp.variables.keys()):
                                        vens = grp.createVariable("level", np.int32, ("level",))
                                        vens[:] = np.array([0])

                                    multivat = grp.createVariable(k, "f8", ("time", "level", "latitude", "longitude",),
                                    ...
                                    for i, vg in enumerate(v[0]):
                                        ...
                                        if k not in list(grp.variables.keys()):
                                            multivat = grp.createVariable(k, "f8",
                        ...
                        if len(v) == 1:
                            if k not in list(grp.variables.keys()):
                                if len(v[0]) == 1:
                                    ...
                                    multivat = grp.createVariable(k, "f8", ("time", "level", "latitude", "longitude",),
                                                                  fill_value=np.NAN, zlib=True, least_significant_digit=3)
                                    if len(str(v[0][0]).split(":")[5].split(' ')) == 3:
                                        vens[:] = np.array([int(str(v[0][0]).split(":")[5].split(' ')[1])])
                                        vens.units = str(v[0][0]).split(":")[5].split(' ')[2]
                                    ...
                                    for i, vg in enumerate(v[0]):
                                        ...
                                        if dimv not in list(grp.variables.keys()):
                                            if str(v[0][i]).split(":")[5].split(' ')[1].isdigit():
                                                ...
                                                vlevel = grp.createVariable(dimv, np.str, (dimv,), fill_value=0)
                                        if k not in list(grp.variables.keys()):
                                            multivat = grp.createVariable(k, "f8",('time', dimv, "latitude", "longitude",),fill_value=np.NAN,zlib=True,least_significant_digit=3)
...
if __name__ == '__main__':
    ...
    grib_to_hdf_batGenNCfile(sourcePath, destinationPath, 'abc')
