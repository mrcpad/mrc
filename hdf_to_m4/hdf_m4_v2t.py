...
class HDF_to_M4(Micaps4property):
    ...
    def __init__(self, hdfFilePath,outPath,condtion):
        ...
        if os.path.exists(hdfFilePath):
            ...
            if self.fg == 'm42hdf':
                vs = self.hdf.groups['m4'].get_variables_by_attributes(axis='T')
...
if __name__ == '__main__':
    ...
    c = HDF_to_M4(r'/home/trywangdao/mrcpysrc/m4/log/2/20190924060623aaaaa.hdf', r'/home/trywangdao/mrcpysrc/data/m4file', '')
    print(c.flag)
