    ...
    def __init__(self, ncFilePath,outPath,condtion):
        ...
        if os.path.exists(ncFilePath):
            ...
            if self.fg == 'm42nc':
                ...
                ft = datetime.datetime.strptime(str(vs[0][:][0].split('<-')[0]), '%Y-%m-%d %H')
                ...
                if len(self.nc.variables[var].dimensions) == 2:#解析二维数据
                   ...
                   pass
                    ...
                    #
                        ...
                        for tk, tvinx in self.timedict.items():
                            for lk, lvinx in self.leveldict.items():
                                print(self.nc.variables[var][tvinx, lvinx, :, :].shape)
...
if __name__ == '__main__':
    ...
    c = NC_to_M4(r'/home/trywangdao/mrcpysrc/m4/log/1908050000.nc', r'/home/trywangdao/mrcpysrc/data/m4file', '')
    print(c.flag)
    #print(nc.ncattrs())
