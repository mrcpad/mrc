...
import enum
from netCDF4 import Dataset, Variable, Dimension, OrderedDict, num2date
...
from netcdf.algorithmbase import PyMeteoDataInfo
#from algorithmbase import PyMeteoDataInfo
...
class Nc(PyMeteoDataInfo):
    ...
    def dim_variable(self, value):
        self._dim_variable = value if isinstance(value, OrderedDict) else None
    ...
    def var_variable(self, value):
        self._var_variable = value if isinstance(value, OrderedDict) else None
    ...
    def variables_data_orderDict(self, value):
        self._variables_data_orderDict = value if isinstance(value, OrderedDict) else None
